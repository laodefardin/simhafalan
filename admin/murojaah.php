  ...
  <div class="grid grid-cols-12 gap-6">
    ...
    <div class="col-span-12 lg:col-span-8 md:col-span-5 2xl:col-span-8">
      ...
      <div class="intro-y box mt-5">
        ...
        <div class="p-5">
          <form action="murojaah_app/tambah" method="post">
            <div class="grid grid-cols-12 gap-x-5">
              <input id="id" name="id" type="text" class="form-control" value="" hidden>
              <div class="col-span-12 xl:col-span-6">
                <div>
                  <label for="tanggal" class="form-label">Tanggal</label>
                  <input id="tanggal" name="tanggal" type="date" class="form-control" placeholder="Input text" value=""
                    required>
                </div>
                <div class="mt-3">
              ...
              <div class="col-span-12 xl:col-span-12">
                <table id="example" class="display">
                  ...
                  <tbody>
                    <?php
                $nomor_urut = 1;
                $query = "SELECT h.*, s.nis, s.kelas, s.nama FROM tb_murojaah h INNER JOIN tb_santri s ON h.id_santri = s.id ORDER BY h.updated_at DESC";
                $hasil = mysqli_query($koneksi, $query);
                foreach ($hasil as $data) : ?>
                    <tr>
                      ...
                      <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                          <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#edit-murojaah<?=$data['id']?>"
                    ...
                    <?php include 'murojaah_app/edit.php'; ?>
                        ...
                        <div class="modal-content">
                          <div class="modal-body p-0">
                            ...
                            <div class="px-5 pb-8 text-center">
                              ...
                              <a href="murojaah_app/hapus?id=<?= $data['id']?>" class="btn btn-danger w-24">Delete</a>
                            </div>
                          </div>
                        </div>
                      </div>
...
<script>
  function cariSantri() {
    ...
    xhr.open("POST", "murojaah_app/cari_santri.php", true);
